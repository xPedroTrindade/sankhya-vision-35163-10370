...
const AdminDashboardPage = () => {
  ...
  const filteredTicketsByMonth = useMemo(() => {
    ...
    if (!selectedCompany) return baseTickets;
  ...
  }, [tickets, filterMonth, filterYear, selectedCompany]);
      ...
      <main className="container mx-auto px-4 py-8">
        {!selectedCompany && tickets.length > 0 && (
          <Alert className="mb-6">
            ...
            <AlertDescription>
              Selecione uma empresa no cabeçalho para visualizar os dados
            </AlertDescription>
          </Alert>
        )}
        ...
        {tickets.length === 0 ? (
          <div className="max-w-3xl mx-auto mt-12">
            ...
            <div className="mt-8 p-6 rounded-lg bg-muted/30 border border-border">
              ...
              <ol className="space-y-2 text-sm text-muted-foreground">
                <li>1. Exporte seus tickets de suporte em formato JSON (.json), Excel (.xlsx) ou CSV (.csv)</li>
                <li>2. Certifique-se de que o arquivo contém os campos necessários</li>
                <li>3. Faça upload do arquivo usando o botão acima</li>
                <li>4. Visualize insights automáticos, gráficos e métricas de desempenho</li>
              </ol>
            </div>
          </div>
        ) : (
          <>
            ...
            />
            <AdminDashboard 
              tickets={filteredTicketsByMonth} 
